...
/* themes/contrib/subteam/templates/content/page--taxonomy.html.twig */
class __TwigTemplate_82837982bcd2f9794212216fc5e0f6095bd854e39476f833d9ad32ef354392f4 extends \Twig\Template
{
...
($context["page"] ?? null), "sidebar_first", [])) && twig_test_empty($this->getAttribute(($context["page"] ?? null), "sidebar_second", [])))) ? ("col-sm-12") : (""))];
        ...
        // line 126
        echo "    <div class=\"taxonomy-content\">
    ";
        // line 127
        echo $this->env->getExtension('Drupal\Core\Template\TwigExtension')->escapeFilter($this->env, $this->sandbox->ensureToStringAllowed($this->getAttribute(($context["page"] ?? null), "taxonomy_content", [])), "html", null, true);
        echo "
    </div>
...
";
  ...
  ";
    ...
    {
        return "themes/contrib/subteam/templates/content/page--taxonomy.html.twig";
    }
...
{% if page.footer %}
  ...
  {% endblock %}
{% endif %}
", "themes/contrib/subteam/templates/content/page--taxonomy.html.twig", "C:\\xampp\\htdocs\\teamProject\\themes\\contrib\\subteam\\templates\\content\\page--taxonomy.html.twig");
    }
}
